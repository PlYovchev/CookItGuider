...
namespace CookItUniversal.Pages
{
    ...
    /// </summary>
    public sealed partial class RecipiesPage : Page
    {
        ...
        public RecipiesPage()
            : this(new RecipiesViewModel())
        {
        }

        public RecipiesPage(RecipiesViewModel recipiesVM)
        {
        ...
        {
            if (this.RecipeListView.SelectedItems.Count != 1)
            {
        ...
        {
            this.Frame.Navigate(typeof(RecipeDetailsPage), this.RecipeListView.SelectedItems[0]);
        }
    }
}
